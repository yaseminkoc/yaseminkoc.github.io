import CV_Resume from './Yasemin_Koc_Resume.pdf'
    ...
    <div>
        <main id='skills' className='py-6 px-4 sm:p-6 md:py-10 md:px-8'>
            <div className='max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2'>
                ...
                <h1 className='mt-1 text-lg font-semibold text-white sm:text-slate-900 md:text-3xl'>Software Developer</h1>
                ...
                <div data-aos='fade-up' data-aos-delay='300' className='grid gap-4 col-start-1 col-end-3 row-start-1 sm:mb-6 sm:grid-cols-4 lg:gap-6 lg:col-start-2 lg:row-end-6 lg:row-span-6 lg:mb-0'>
                    <img src={Frontend} alt="" className='w-full h-120 object-cover rounded-lg sm:h-60 sm:col-span-2 lg:col-span-full' loading='lazy'/>
                </div>
